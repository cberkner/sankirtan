...
if ($oPlugin->oPluginEinstellungAssoc_arr[S360_LPA_CONFKEY_ADVANCED_USEIPN] === '0') {
    ...
    try {
        ...
        // Load all open or suspended orders without the backing Bestellung information (faster this way)
        $orders = $database->getOrders(false, array(S360_LPA_STATUS_OPEN, S360_LPA_STATUS_SUSPENDED));
