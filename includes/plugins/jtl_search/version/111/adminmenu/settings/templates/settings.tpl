...
<form method="post" enctype="multipart/form-data" name="settings">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="item input-group">
				<span class="input-group-addon">
					<label for="jtlsearch_branding">JTL-Logo bei Suchvorschl&auml;gen anzeigen</label>
				</span>
				<span class="input-group-wrap">
					<select id="jtlsearch_branding" class="form-control" name="jtlsearch_branding">
						<option value="1" {if isset($oSettings_arr->jtlsearch_branding) && $oSettings_arr->jtlsearch_branding === 1} selected="selected"{/if} >Ja</option>
						<option value="0" {if isset($oSettings_arr->jtlsearch_branding) && $oSettings_arr->jtlsearch_branding === 0} selected="selected"{/if} >Nein</option>
					</select>
				</span>
			</div>
		</div>
