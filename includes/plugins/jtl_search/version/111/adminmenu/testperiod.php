...
$oForm->addElement('cCode', 'textarea', 'Lizenzschlüssel: ', ['style' => 'width: 500px; height: 120px;']);
$oForm->addElement('btn_serverinfo', 'submit', '', ['value' => 'Suche aktivieren', 'class' => 'btn btn-primary button orange']);
