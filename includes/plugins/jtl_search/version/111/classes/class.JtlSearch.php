...
class JtlSearch
{
     ...
     * @param string      $cAuthHash
     * @param string      $cServerUrl
     * @param null|object $oResponse
     * @return array
     */
                ...
                foreach ($oFilterGroup->oFilterItem_arr as $oFilterItem) {
                    if ($oFilterItem->bSet) {
                        if (!isset($cStatedFilterAssoc_arr[$oFilterGroup->cName])) {
                            $cStatedFilterAssoc_arr[$oFilterGroup->cName] = [];
                        }
